...
function loadProps(explicitProps, confString) {
  ...
  if (confString) {
    try {
      props = {
        ...(_a = JSON.parse(confString)) == null ? undefined : _a.analytics,
        ...explicitProps
      };
    } catch {}
  }
...
function loadProps2(explicitProps, confString) {
  ...
  if (confString) {
    try {
      props = {
        ...(_a = JSON.parse(confString)) == null ? undefined : _a.speedInsights,
        ...explicitProps
      };
    } catch {}
  }
...
// app/static/js/vercel-observability.ts
function isLocalDevelopmentHost(hostname) {
  return hostname === "localhost" || hostname === "127.0.0.1" || hostname === "[::1]" || hostname.endsWith(".local");
}
function bootVercelObservability() {
